...
var SCHEMA = {
  ...
  Receipt_URL:         ['Payment_ID','Student_ID','Receipt_URL'],

  // ── Future Module Tables (architecture ready) ────────────────────────────
  Timetable:           ['Timetable_ID','Centre','Batch','Course','Subject','Teacher_ID','Day_Of_Week','Start_Time','End_Time','Classroom','Status'],
  Test_Papers:         ['Paper_ID','Paper_Name','Course','Subject','Total_Marks','Duration_Minutes','Status','Created_At'],
  Test_Results:        ['Result_ID','Paper_ID','Student_ID','Marks_Obtained','Total_Marks','Percentage','Rank','Status','Submitted_At'],
  Assignments:         ['Assignment_ID','Title','Course','Subject','Teacher_ID','Due_Date','Max_Marks','Status','Created_At'],
  Assignment_Submissions:['Submission_ID','Assignment_ID','Student_ID','File_URL','Marks','Status','Submitted_At'],
  Visitor_Log:         ['Visit_ID','Name','Phone','Purpose','Host','Check_In','Check_Out','Gate_Pass_No','Status'],
